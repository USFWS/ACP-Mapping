...
Osnas, E. E. (2026). Periodicity in Steller's eider (*Polysticta stelleri*) population size and density on the Arctic Coastal Plain, Alaska, revealed using generalized additive models. PLOS One, in press. 

Wood, S.N. (2017) Generalized Additive Models: An Introduction with R (2nd edition). Chapman and Hall/CRC.

## 2026 Data Release!

Following review and publication of the work on Steller's eider (Osnas 2026, in press), a set of GAM models were fit to each of 20+ species present on the ACP and the best fitting model used to predict year-specific and average density across the ACP. These results will be reported in [Wilson et al. 2026]() and released on [ScienceBase]() for public use. The main products of this release are (1) the `mgcv` model fit R object for the best fitting GAM model, an html report describing AIC of the various models fit and model checking diagnostics, and Geotiff files containing density rasters for each species for 2007, 2025, and the average density across time (2007 to 2025, i.e., the partial effect of space after removing observer, year, and the space-year interaction). Other years or effects can be predicted based on knowledge of the R package `mgcv`, the GAM model object, and the code found in `write_map.R` or elsewhere on this site. 
